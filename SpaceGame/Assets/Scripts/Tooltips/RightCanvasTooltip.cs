...
public class RightCanvasTooltip : MonoBehaviour {
	...
	public void OnGUI()
	{
		if (currentToolTipText != "")
		{
			...
			GUI.Label (new Rect (x-149,y+21,200,60), currentToolTipText, guiStyleBack);
			GUI.Label (new Rect (x-150,y+20,200,60), currentToolTipText, guiStyleFore);
		}
	}
}
